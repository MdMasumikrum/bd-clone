...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtube.com/c/MasumTechnologychannel')
    else:
        print "\033[1;94mWrong Username"
        os.system('https://www.facebook.com/TermuxteacherMasum')
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe Masum Technology Youtube Channel " 
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mMasumYT\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
	...
	p.map(main, id)
#Dev:Babar_Ali
        print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mMasum Islam\033[1;95m-_-_-_-_-_-_-_-_-»"
...
print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mMasum\033[1;95m-_-_-_-_-_-_-_-_-»"
